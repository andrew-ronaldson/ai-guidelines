...
- [Crossed out AI troubleshooting and AI chat icons that have been re-colored](../assets/images/do-not-modify-or-change-colors-ui-icons.svg "dont") **Don't** change the colors of the UI icons or modify them. Use them in the same colors as other UI icons in the interface.
